...
class GridColorPickerViewController: UIViewController {
...
extension GridColorPickerViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
